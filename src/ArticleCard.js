  ...
  goto=()=>{
    ...
    render(){
     ...
     var url='/ahome/'+this.state.author_id+'/'+this.state.article_id;
      ...
      var title='';
      var title_image = <div style={{width:'20%',height:'100px',overflow:'hidden',float:'left',marginRight:20,marginTop:15}}><img src={this.state.title_image} style={{width:'100%',height:'auto'}}/></div>
      if(this.props.hover){
          title_image = ""
          var bk='white';var color='black';
        ...
        title=<a className={titleName} href={url} target='_blank' onMouseEnter={this.handleEnter.bind(this,'title')}  onMouseLeave={this.handleOut.bind(this,'title')} rel="noopener noreferrer" style={{width:250,fontWeight:'bolder',fontSize:'18px',color:'black',textDecoration:'none',display:'block'}}>{this.state.title}</a>
      }
      var edit='';
      if(this.props.edit){
    ...
    if(this.state.collect){
      ...
      else{ text=this.state.message; title_image=""}
